...
import com.example.tdkinvences.databinding.ActivityMainBinding
import com.punchthrough.blestarterappandroid.ble.ConnectionEventListener
import com.punchthrough.blestarterappandroid.ble.ConnectionManager
import com.punchthrough.blestarterappandroid.hasRequiredBluetoothPermissions
import com.punchthrough.blestarterappandroid.requestRelevantBluetoothPermissions
...
class MainActivity : AppCompatActivity() {
    ...
    private val scanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            ...
            if (deviceName == null || deviceName.contains("unknown", ignoreCase = true)) {
                Timber.i("Device filtered out: Name: ${deviceName ?: "Unnamed"}, Address: ${result.device.address}")
                return
            }
